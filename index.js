//CURRYING FUNCTION
//A function that takes multiple arguments and returns other or a sequence of functions each with a single arguments
//example
...
function useLet(x) {
  ...
  switch (x) {
    ...
    case 1:
      name = "Jared"; // SyntaxError for redeclaration.
      break;
  }
...
//I.E if(key in obj) returns a truthy value

//TO ITERATE OR LOOP OVER AN OBJECT - USE THE "FOR-IN"
